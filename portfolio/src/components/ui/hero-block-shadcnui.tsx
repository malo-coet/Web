...
import { ArrowDown, GitBranch, BriefcaseBusiness, Mail } from "lucide-react";
    ...
    <section className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        >
          ...
          >
            Crafting beautiful, performant web applications with modern technologies. Passionate about clean code and exceptional user experiences.
          </motion.p>
